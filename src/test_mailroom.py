...
@pytest.mark.parametrize('donor_dictionary, result', [(small_donors, ['Stephanie Jones', 'Joseph Ramos'])])
...
@pytest.mark.parametrize('user_input, result', [('Joseph Ramos', True),
                         ('Michel', True), ('%', False), ('873', False), ('', False)])
...
@pytest.mark.parametrize('user_input, result', [('100.22336', True), ('20', True),
                         ('', False), ('letter', False), ('***', False)])
